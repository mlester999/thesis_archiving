<x-guest-layout>
    <x-auth-card>
        <section>
            ...
            <p class="text-gray-600 pt-2 text-center">Please register your account.</p>
        </section>
        ...
        <form method="POST" action="{{ route('register') }}" class="flex flex-col">
            ...
            <div class="flex items-center justify-end">
                <a class="text-sm text-slate-600 hover:text-slate-700 hover:underline mb-6" href="{{ route('login') }}">
